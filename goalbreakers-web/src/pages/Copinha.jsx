...
export default function FormularioCopinha() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-black flex flex-col items-center px-6 py-12 text-white">
      ...
      <p className="text-gray-300 mb-8 text-center">Formulário de inscrição</p>
      ...
      >
        ...
        {jogadores.map((j, index) => (
          <div key={index} className="grid md:grid-cols-3 gap-6 items-end mb-4">
            ...
            <div className="flex flex-col">
              <label className="mb-1 font-semibold">Data de nascimento:</label>
              <input
                type="text"

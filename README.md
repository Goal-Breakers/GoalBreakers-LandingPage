...
Nossa aplicação foi desenvolvida utilizando tecnologias modernas e práticas de desenvolvimento robustas:

### 💻 Stack Técnica

- **React + Vite:** Para uma experiência de desenvolvimento rápida e eficiente
- **Context API:** Gerenciamento de estado global com `useContext` para:
  - Autenticação de usuários
  - Gestão de campeonatos e eventos
- **Simulação de Backend:**
  - API simulada com arquivos JSON para dados de jogadoras e eventos
  - Sistema de autenticação simulado para demonstração completa do fluxo
- **Roteamento:**
...
- **Gestão de Eventos:**
  - Visualização de copinhas e torneios
...
Nossa aplicação está hospedada na Vercel, garantindo alta disponibilidade e performance. O design foi pensado para ser responsivo e acessível em qualquer dispositivo.
